...
Source0  : https://files.pythonhosted.org/packages/4f/9c/fd040e3291e6b123fb35474c8c685b9afa8f14abd4efba3fe2fa2b71ea2c/coverage-6.3.1.tar.gz
...
%prep
%setup -q -n coverage-6.3.1
cd %{_builddir}/coverage-6.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643816328
...
cp %{_builddir}/coverage-6.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-coverage/598f87f072f66e2269dd6919292b2934dbb20492
