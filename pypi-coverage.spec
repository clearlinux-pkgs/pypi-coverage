...
Source0  : https://files.pythonhosted.org/packages/80/f4/e7d2c659aca9db9edd2f58a604a79756e332c8b20659ed6d8b116c21baad/coverage-6.2.tar.gz
...
%prep
%setup -q -n coverage-6.2
cd %{_builddir}/coverage-6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641425133
...
cp %{_builddir}/coverage-6.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-coverage/598f87f072f66e2269dd6919292b2934dbb20492
