...
Version  : 7.2.0
Release  : 142
URL      : https://files.pythonhosted.org/packages/10/44/cadfed76f14e5fd2a8754c4443af064f00237724ddf858a970116d6e80fc/coverage-7.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/10/44/cadfed76f14e5fd2a8754c4443af064f00237724ddf858a970116d6e80fc/coverage-7.2.0.tar.gz
...
%prep
%setup -q -n coverage-7.2.0
cd %{_builddir}/coverage-7.2.0
pushd ..
cp -a coverage-7.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677183183
