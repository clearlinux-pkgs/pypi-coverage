...
Version  : 7.6.5
Release  : 177
URL      : https://files.pythonhosted.org/packages/d3/45/817562b52dc4270a9600d2cf7b6d85aa26ea4b7edf9fe10c6147b8ab59c8/coverage-7.6.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/45/817562b52dc4270a9600d2cf7b6d85aa26ea4b7edf9fe10c6147b8ab59c8/coverage-7.6.5.tar.gz
...
%prep
%setup -q -n coverage-7.6.5
cd %{_builddir}/coverage-7.6.5
pushd ..
cp -a coverage-7.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731617609
