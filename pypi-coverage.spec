...
Source0  : https://files.pythonhosted.org/packages/6c/a5/62ae2dc1850feabb74207a422d00893f451ee0950e52792eb208970a30b1/coverage-7.5.3.tar.gz
...
%prep
%setup -q -n coverage-7.5.3
cd %{_builddir}/coverage-7.5.3
pushd ..
cp -a coverage-7.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717010617
