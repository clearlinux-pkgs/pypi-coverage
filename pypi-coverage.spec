...
Version  : 7.0.3
Release  : 138
URL      : https://files.pythonhosted.org/packages/0a/ee/8e01ae96d0872572db225803ffd0bcdf7d4408faa4ae6bd92955f2e504c1/coverage-7.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/ee/8e01ae96d0872572db225803ffd0bcdf7d4408faa4ae6bd92955f2e504c1/coverage-7.0.3.tar.gz
...
%prep
%setup -q -n coverage-7.0.3
cd %{_builddir}/coverage-7.0.3
pushd ..
cp -a coverage-7.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672849465
