...
Source0  : https://files.pythonhosted.org/packages/54/8a/db9d9cd24f96bb872eea151bb0d5c8cb6a96825b70a0cfaf07bceab2884d/coverage-7.2.2.tar.gz
...
%prep
%setup -q -n coverage-7.2.2
cd %{_builddir}/coverage-7.2.2
pushd ..
cp -a coverage-7.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679064573
