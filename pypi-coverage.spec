...
Source0  : https://files.pythonhosted.org/packages/79/f3/8c1af7233f874b5df281397e2b96bedf58dc440bd8c6fdbf93a4436c517a/coverage-6.4.4.tar.gz
...
%prep
%setup -q -n coverage-6.4.4
cd %{_builddir}/coverage-6.4.4
pushd ..
cp -a coverage-6.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660686092
