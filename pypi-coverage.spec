...
Source0  : https://files.pythonhosted.org/packages/ea/34/5a4f7a48da3be173273cd9b866c998eb59e234da2ee4a30c1068e85c0e99/coverage-6.4.2.tar.gz
...
%prep
%setup -q -n coverage-6.4.2
cd %{_builddir}/coverage-6.4.2
pushd ..
cp -a coverage-6.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657658219
...
cp %{_builddir}/coverage-6.4.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-coverage/598f87f072f66e2269dd6919292b2934dbb20492
