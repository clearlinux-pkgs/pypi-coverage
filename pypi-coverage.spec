...
Source0  : https://files.pythonhosted.org/packages/8d/4a/3518606d4b110df4f3e77bd52c241ae8a84c6dc74fac7c2a8e809449e541/coverage-7.2.1.tar.gz
...
%prep
%setup -q -n coverage-7.2.1
cd %{_builddir}/coverage-7.2.1
pushd ..
cp -a coverage-7.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677515232
