...
Source0  : https://files.pythonhosted.org/packages/bf/d5/f809d8b630cf4c11fe490e20037a343d12a74ec2783c6cdb5aee725e7137/coverage-7.4.4.tar.gz
...
%prep
%setup -q -n coverage-7.4.4
cd %{_builddir}/coverage-7.4.4
pushd ..
cp -a coverage-7.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710539218
