...
Source0  : https://files.pythonhosted.org/packages/af/c9/91533449c1c8685aa09b89069a73f181a0d841b53a4516798e80af6efc5e/coverage-6.4.tar.gz
...
%prep
%setup -q -n coverage-6.4
cd %{_builddir}/coverage-6.4
pushd ..
cp -a coverage-6.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653334077
...
cp %{_builddir}/coverage-6.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-coverage/598f87f072f66e2269dd6919292b2934dbb20492
