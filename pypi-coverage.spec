...
%prep
%setup -q -n coverage-6.4.1
cd %{_builddir}/coverage-6.4.1
pushd ..
cp -a coverage-6.4.1 buildavx2
popd
...
cp %{_builddir}/coverage-6.4.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-coverage/598f87f072f66e2269dd6919292b2934dbb20492
