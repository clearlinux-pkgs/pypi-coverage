...
Source0  : https://files.pythonhosted.org/packages/f7/08/7e37f82e4d1aead42a7443ff06a1e406aabf7302c4f00a546e4b320b994c/coverage-7.6.1.tar.gz
...
%prep
%setup -q -n coverage-7.6.1
cd %{_builddir}/coverage-7.6.1
pushd ..
cp -a coverage-7.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722871049
