...
Version  : 7.0.0
Release  : 133
URL      : https://files.pythonhosted.org/packages/0e/83/fed23fd84873be8c6342b679efad5d1016192b237a6929f73399f18dfedf/coverage-7.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/83/fed23fd84873be8c6342b679efad5d1016192b237a6929f73399f18dfedf/coverage-7.0.0.tar.gz
...
%prep
%setup -q -n coverage-7.0.0
cd %{_builddir}/coverage-7.0.0
pushd ..
cp -a coverage-7.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671473502
