...
Version  : 7.0.4
Release  : 139
URL      : https://files.pythonhosted.org/packages/54/29/6eaa9d6e92adeb724f49fd6d132325a0cc38196bb186837af8c819628799/coverage-7.0.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/54/29/6eaa9d6e92adeb724f49fd6d132325a0cc38196bb186837af8c819628799/coverage-7.0.4.tar.gz
...
%prep
%setup -q -n coverage-7.0.4
cd %{_builddir}/coverage-7.0.4
pushd ..
cp -a coverage-7.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673280904
