...
Source0  : https://files.pythonhosted.org/packages/18/a0/bfa6c6ab7a5f0aeb69dd169d956ead54133f5bca68a5945c4569ea2c40b3/coverage-7.1.0.tar.gz
...
%prep
%setup -q -n coverage-7.1.0
cd %{_builddir}/coverage-7.1.0
pushd ..
cp -a coverage-7.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674660585
