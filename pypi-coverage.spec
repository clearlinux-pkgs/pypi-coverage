...
Source0  : https://files.pythonhosted.org/packages/ca/41/e2ba20f090d0d16b73ad1f6fc542eb31b0db20662576583fb4f02554891f/coverage-7.4.1.tar.gz
...
%prep
%setup -q -n coverage-7.4.1
cd %{_builddir}/coverage-7.4.1
pushd ..
cp -a coverage-7.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706306507
